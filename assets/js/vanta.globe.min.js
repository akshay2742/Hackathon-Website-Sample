                ...
                onUpdate() {
                    ...
                    for (let t = 0; t < this.points.length; t++) {
                        ...
                        const l = this.points[t],
                            u = (n = this.rayCaster ? this.rayCaster.ray.distanceToPoint(l.position) : 1e3).clamp(5, 15);
                        l.scale.z = (.25 * (15 - u)).clamp(1, 100), l.scale.x = l.scale.y = l.scale.z, l.position.y = 2 * Math.sin(l.position.x / 10 + .01 * this.t + l.position.z / 10 * .5);
                        for (let n = t; n < this.points.length; n++) {
                            ...
                            if ((e = Math.sqrt(u * u + p * p + d * d)) < this.options.maxDistance) {
                                let n, u = 2 * (1 - e / this.options.maxDistance);
                                u = u.clamp(0, 1), n = "additive" === this.blending ? new r.Color(0).lerp(c, u) : h.clone().lerp(a, u), this.linePositions[i++] = l.position.x, this.linePositions[i++] = l.position.y, this.linePositions[i++] = l.position.z, this.linePositions[i++] = t.position.x, this.linePositions[i++] = t.position.y, this.linePositions[i++] = t.position.z, this.lineColors[s++] = n.r, this.lineColors[s++] = n.g, this.lineColors[s++] = n.b, this.lineColors[s++] = n.r, this.lineColors[s++] = n.g, this.lineColors[s++] = n.b, o++
                            }
                        }
                    }
